...
const MOCK_LINK_PREVIEWS: Record<string, LinkMetaData> = {
  "techcrunch.com": {
    ...
    description:
      "Deep dive into dynamic model routing, long context windows, and hallucination reduction strategies.",
  ...
  "deepmind.google": {
    ...
    description:
      "Full benchmark breakdown across 24 reasoning, multimodal, and code generation test suites.",
  ...
  "github.com": {
    ...
    description:
      "Zero-dependency 120-line tool-use loop written in Python. Star and fork on GitHub.",
