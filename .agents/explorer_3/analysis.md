...
* **Defect Mechanism**:
  ...
  2. `themeInitScript` in `src/lib/theme.ts` contains:
     ```js
     (function(){try{var t=localStorage.getItem('croxcom-theme');if(t!=='light'){document.documentElement.classList.add('dark');}}catch(e){document.documentElement.classList.add('dark');}})();
     ```
